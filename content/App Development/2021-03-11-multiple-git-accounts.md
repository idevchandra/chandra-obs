...
# 1. Create SSH keys for the accounts 
---------------------------------------
...
# 3. Add the respective public SSH keys to the Git websites
---------------------------------------
...
# 4. Create config file on your Mac
---------------------------------------
...
# 6. Use Git with Non-default or Secondary Accounts
---------------------------------------
...
# 7. Push from already cloned repositors
---------------------------------------

Referring the `config` file, you can use this command to use a particular git account.

1. Set the remote URL for the repo and other parameters

```shell
git remote set-url origin git@github.com-{GIT_ACCOUNT_NAME_1}:yourusername/yourrepo.git

git config user.name "YourName"
git config user.email "GIT_ACCOUNT_NAME_1@email.com"
```
